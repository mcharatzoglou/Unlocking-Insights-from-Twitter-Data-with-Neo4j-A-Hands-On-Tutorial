...
#4 Get the 20 users with most followers in descending order
query4 = """
    MATCH (n:User)
...
#8 Run PageRank on the mention network
query8_1 = """
...
#9 Get the 20 users with most similar hashtags to the 6th important user(as the others used no hashtags)
...
#10 Get the community that each user belongs to in the MENTION graph according to Louvain algorithm
query10 = """
